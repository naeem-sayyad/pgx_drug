"""Train the CatBoost model for PGx toxicity."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train CatBoost toxicity classifier.")
...
def main() -> None:
    args = parse_args()
    logging.basicConfig(level=logging.INFO, format="[train_cat] %(message)s")
